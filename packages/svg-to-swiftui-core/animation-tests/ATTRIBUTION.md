# Animation fixture attribution

Project-authored fixtures are covered by the repository MIT license. The following files are vendored unchanged, tested without network access, and pinned by exact SHA-256 in `fixture-source-lock.json`.

| Fixture | Author/project | Upstream revision | License |
| --- | --- | --- | --- |

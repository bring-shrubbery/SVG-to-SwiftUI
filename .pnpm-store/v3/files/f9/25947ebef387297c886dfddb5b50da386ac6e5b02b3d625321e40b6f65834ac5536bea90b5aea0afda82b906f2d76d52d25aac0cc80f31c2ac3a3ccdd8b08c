...
var require_consola = _chunkWXLEX5S3js.__commonJS.call(void 0, {
  "node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js"(exports, module) {
    ...
    var D = u(_chunkWXLEX5S3js.__require.call(void 0, "util"));
    var e = _chunkWXLEX5S3js.__require.call(void 0, "path");
    var t = _chunkWXLEX5S3js.__require.call(void 0, "fs");
    var r = u(_chunkWXLEX5S3js.__require.call(void 0, "os"));
    var n = u(_chunkWXLEX5S3js.__require.call(void 0, "tty"));
    function s(u2, D2) {
    ...
    var _ = class {
      constructor(u2 = {}) {
        ...
        for (const u3 in this._types) {
          const D2 = _chunkWXLEX5S3js.__spreadValues.call(void 0, _chunkWXLEX5S3js.__spreadValues.call(void 0, { type: u3 }, this._types[u3]), this._defaults);
      ...
      _logFn(u2, D2, e2) {
        ...
        const r2 = (u3 = false) => {
          ...
          if (this._lastLog && D3 > 0) {
            ...
            D3 > 1 && u4.push(`(repeated ${D3} times)`), this._log(_chunkWXLEX5S3js.__spreadProps.call(void 0, _chunkWXLEX5S3js.__spreadValues.call(void 0, {}, this._lastLog), { args: u4 })), this._lastLogCount = 1;
          }
          if (u3) {
    ...
    }, _chunkWXLEX5S3js.__spreadProps.call(void 0, _chunkWXLEX5S3js.__spreadValues.call(void 0, {}, _u), { level: { enumerable: true, get() {
    ...
    var Gu = typeof __non_webpack_require__ != "undefined" ? __non_webpack_require__ : _chunkWXLEX5S3js.__require;
    var zu = class {
      constructor(u2) {
        if (u2 && u2.log)
          this.logger = u2;
  ...
  return {
    ...
    setup(build2) {
      ...
      const getPostcssConfig = async (file) => {
        const loadConfig = _chunkWXLEX5S3js.__require.call(void 0, "postcss-load-config");
      ...
      build2.onLoad({ filter: /\.css$/ }, async (args) => {
        ...
        if (plugins || plugins.length > 0) {
          const postcss = _chunkWXLEX5S3js.getPostcss.call(void 0, );
          if (!postcss) {
            return {
              errors: [
                {
          ...
          const result = await (postcss == null ? void 0 : postcss.default(plugins).process(contents, _chunkWXLEX5S3js.__spreadProps.call(void 0, _chunkWXLEX5S3js.__spreadValues.call(void 0, {}, options), { from: args.path })));
          contents = result.css;
        }
        if (inject) {
  ...
  return {
    ...
    setup(build2) {
      ...
      build2.onLoad({ filter: /\.svelte$/ }, async (args) => {
        svelte = svelte || _chunkWXLEX5S3js.localRequire.call(void 0, "svelte/compiler");
        if (!svelte) {
          return {
...
// src/esbuild/index.ts
var import_consola = _chunkWXLEX5S3js.__toESM.call(void 0, require_consola());
...
var swcPlugin = ({ logger }) => {
  return {
    name: "swc",
    setup(build2) {
      const swc = _chunkWXLEX5S3js.localRequire.call(void 0, "@swc/core");
      if (!swc) {
  ...
  return {
    ...
    setup(build2) {
      build2.onResolve({ filter: /\.node$/, namespace: "file" }, (args) => {
        const resolvedId = _chunkWXLEX5S3js.__require.resolve(args.path, {
...
async function runEsbuild(options, {
  ...
  const pkg = await _chunkPEG4CWPPjs.loadPkg.call(void 0, process.cwd());
  ...
  const env = _chunkWXLEX5S3js.__spreadValues.call(void 0, {}, options.env);
  ...
  try {
    result = await _esbuild.build.call(void 0, {
      ...
      loader: _chunkWXLEX5S3js.__spreadValues.call(void 0, {
        ".aac": "file",
        ".css": "file",
        ".eot": "file",
        ".flac": "file",
      ...
      plugins: esbuildPlugins.filter(_chunkWXLEX5S3js.truthy),
      define: _chunkWXLEX5S3js.__spreadValues.call(void 0, _chunkWXLEX5S3js.__spreadValues.call(void 0, _chunkWXLEX5S3js.__spreadValues.call(void 0, {
  ...
  if (result && result.warnings && !_chunkPEG4CWPPjs.getSilent.call(void 0, )) {
...
var es5 = () => {
  ...
  return {
    ...
    async renderChunk(code, info) {
      ...
      const swc = _chunkWXLEX5S3js.localRequire.call(void 0, "@swc/core");
      if (!swc) {
        throw new (0, _chunkM24XL6CIjs.PrettyError)("@swc/core is required for es5 target. Please install it with `npm install @swc/core -D`");
      }
...
var sizeReporter = () => {
  return {
    ...
    buildEnd({ writtenFiles }) {
      _chunkPEG4CWPPjs.reportSize.call(void 0, this.logger, this.format, writtenFiles.reduce((res, file) => {
        return _chunkWXLEX5S3js.__spreadProps.call(void 0, _chunkWXLEX5S3js.__spreadValues.call(void 0, {}, res), {
          [file.name]: file.size
        });
      }, {}));
...
var normalizeOptions = async (logger, optionsFromConfigFile, optionsOverride) => {
  var _a, _b, _c, _d;
  const _options = _chunkWXLEX5S3js.__spreadValues.call(void 0, _chunkWXLEX5S3js.__spreadValues.call(void 0, {}, optionsFromConfigFile), optionsOverride);
  const options = _chunkWXLEX5S3js.__spreadProps.call(void 0, _chunkWXLEX5S3js.__spreadValues.call(void 0, {
    target: "node14",
    outDir: "dist"
  }, _options), {
  ...
  if (!entry || Object.keys(entry).length === 0) {
    throw new (0, _chunkM24XL6CIjs.PrettyError)(`No input files, try "tsup <your-file>" instead`);
  }
  if (Array.isArray(entry)) {
    options.entry = await _globby2.default.call(void 0, entry);
    if (!options.entry || options.entry.length === 0) {
      throw new (0, _chunkM24XL6CIjs.PrettyError)(`Cannot find ${entry}`);
    } else {
    ...
    Object.keys(entry).forEach((alias) => {
      ...
      if (!_fs2.default.existsSync(filename)) {
        throw new (0, _chunkM24XL6CIjs.PrettyError)(`Cannot find ${alias}: ${filename}`);
      }
    });
    options.entry = entry;
  ...
  if (tsconfig) {
    ...
    throw new (0, _chunkM24XL6CIjs.PrettyError)(`Cannot find tsconfig: ${options.tsconfig}`);
  }
  return options;
};
async function build(_options) {
  const config = _options.config === false ? {} : await _chunkPEG4CWPPjs.loadTsupConfig.call(void 0, process.cwd(), _options.config === true ? void 0 : _options.config);
  ...
  await Promise.all([...Array.isArray(configData) ? configData : [configData]].map(async (item) => {
    const logger = _chunkPEG4CWPPjs.createLogger.call(void 0, item == null ? void 0 : item.name);
      ...
      if (options.dts) {
        await new Promise((resolve, reject) => {
          ...
          worker.postMessage({
            ...
            options: _chunkWXLEX5S3js.__spreadProps.call(void 0, _chunkWXLEX5S3js.__spreadValues.call(void 0, {}, options), {
              banner: void 0,
              footer: void 0,
    ...
    const otherTasks = async () => {
      ...
      if (!((_a = options.dts) == null ? void 0 : _a.only)) {
        ...
        const debouncedBuildAll = _chunkWXLEX5S3js.debouncePromise.call(void 0, () => {
          return buildAll();
        }, 100, _chunkM24XL6CIjs.handleError);
        const buildAll = async () => {
          ...
          if (options.clean) {
            ...
            await _chunkWXLEX5S3js.removeFiles.call(void 0, ["**/*", "!**/*.d.ts", ...extraPatterns], options.outDir);
          ...
          if (options.onSuccess) {
            existingOnSuccess = _execa2.default.call(void 0, options.onSuccess, {
              shell: true,
              stdio: "inherit"
            });
          }
        ...
        const startWatcher = async () => {
          ...
          watcher.on("all", (type, file) => {
            file = _chunkWXLEX5S3js.slash.call(void 0, file);

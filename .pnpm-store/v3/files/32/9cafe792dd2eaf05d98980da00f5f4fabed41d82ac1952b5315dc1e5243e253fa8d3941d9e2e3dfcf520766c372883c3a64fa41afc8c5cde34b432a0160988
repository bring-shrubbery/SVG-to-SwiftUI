...
var require_lib2 = _chunkWXLEX5S3js.__commonJS.call(void 0, {
  "node_modules/.pnpm/@babel+highlight@7.16.10/node_modules/@babel/highlight/lib/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var loadCompilerOptions = (tsconfig) => {
  if (!tsconfig)
    return {};
  const configFile = _typescript2.default.readConfigFile(tsconfig, _typescript2.default.sys.readFile);
  const { options } = _typescript2.default.parseJsonConfigFileContent(configFile.config, _typescript2.default.sys, "./");
  return options;
};
